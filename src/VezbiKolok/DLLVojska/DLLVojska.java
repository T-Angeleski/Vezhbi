...
public class DLLVojska {
    ...
    public static DLL<Integer> vojska(DLL<Integer> lista, int a, int b, int c, int d) {
        //Using tmp lists not allowed
        DLLNode<Integer> start1 = null, start2 = null, end1 = null, end2 = null, tmp = null;
        DLLNode<Integer> current = lista.getFirst();

        //Get interval nodes
        while (current != null) {
            if (current.element.equals(a)) start1 = current;
            if (current.element.equals(b)) end1 = current;
            if (current.element.equals(c)) start2 = current;
            if (current.element.equals(d)) end2 = current;
